package com.in100gram.config;

import com.in100gram.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.in100gram.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.in100gram.repository.search")
